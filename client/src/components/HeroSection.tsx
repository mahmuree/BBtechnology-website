  ...
  return (
    <section className="relative h-screen flex flex-col justify-center bg-[#02124d] overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        {/* Main background gradient with specified colors in reverse order */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#02124d] via-[#092381] via-[#4b5a8b] to-[#8088a3]"></div>
        ...
        {/* Subtle light gradients for depth - adjusted for new direction */}
        <div className="absolute top-0 inset-x-0 h-[100px] bg-gradient-to-b from-[#02124d]/30 to-transparent"></div>
        <div className="absolute bottom-0 inset-x-0 h-[100px] bg-gradient-to-t from-[#8088a3]/20 to-transparent"></div>
        
        {/* Diagonal light accent - adjusted for new direction */}
        <div className="absolute top-0 right-0 bottom-0 left-0 overflow-hidden">
          <div className="absolute top-[-10%] left-[-10%] w-[120%] h-[120%] bg-gradient-to-br from-[#02124d]/10 via-[#4b5a8b]/5 to-transparent transform rotate-12 opacity-30"></div>
        </div>
        
        {/* Subtle light edge accents - adjusted for new direction */}
        <div className="absolute top-0 inset-x-0 h-[1px] bg-gradient-to-r from-transparent via-[#02124d]/30 to-transparent"></div>
        <div className="absolute bottom-0 inset-x-0 h-[1px] bg-gradient-to-r from-transparent via-[#8088a3]/20 to-transparent"></div>
      </div>
      {/* Content */}
