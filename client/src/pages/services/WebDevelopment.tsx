...
import { Check, ArrowRight, Code, Layout, Laptop } from "lucide-react";
...
export default function WebDevelopment() {
  // Get the webdev pricing category data
  const serviceData = pricingCategories.find(cat => cat.id === "webdev");
      ...
      <main className="flex-grow">
        ...
        <section className="pt-24 pb-12 relative bg-gradient-to-b from-[#02124d] via-[#092381] to-[#0D2E5C]">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">
              Modern, responsive websites tailored to your goals, built for performance and visual impact.
            </p>
            <Button 
              asChild
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-gray-700 mb-8 text-lg">
                Our Web Development services deliver high-performance, modern websites that balance stunning 
                design with technical excellence. We create responsive, user-friendly websites that are optimized for 
                search engines and built to achieve your specific business goals.
              </p>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-[#081C3A] mb-3">Custom Website Design</h3>
                  <p className="text-gray-600">
                    We design and develop fully custom websites tailored to your brand, goals, and target audience, 
                    creating unique digital experiences that set you apart from competitors.
                  </p>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-[#081C3A] mb-3">E-commerce Solutions</h3>
                  <p className="text-gray-600">
                    From small boutique stores to large enterprise platforms, we build scalable, secure 
                    e-commerce websites with seamless payment processing and inventory management.
                  </p>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-[#081C3A] mb-3">Responsive Development</h3>
                  <p className="text-gray-600">
                    Our websites look and function perfectly on all devices—from desktop to mobile—ensuring 
                    a consistent, optimized experience for all users regardless of screen size.
                  </p>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-[#081C3A] mb-3">Performance Optimization</h3>
                  <p className="text-gray-600">
                    We build lightning-fast websites optimized for speed, SEO, and conversion, with clean code 
                    and best practices that enhance user experience and search engine rankings.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mt-12">
              <p className="text-gray-600 mb-6">
                Need a custom web development solution? Contact us to discuss your project requirements.
              </p>
              <Button 
                asChild
                variant="outline" 
        ...
        <section className="py-16 bg-gradient-to-r from-[#081C3A] to-[#0D2E5C] text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-6">Ready for a Website That Drives Results?</h2>
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Let's create a powerful web presence that elevates your brand, engages your audience, and helps achieve your business goals.
            </p>
            <Button 
              asChild
